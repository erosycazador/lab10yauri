...
{
    public static class MonkeyData_yauri
    {
        public static IList<Monkey_yauri> Monkeys { get; private set; }

        static MonkeyData_yauri()
        {
            Monkeys = new List<Monkey_yauri> ();

            Monkeys.Add(new Monkey_yauri
            {
                Name = "Baboon",
